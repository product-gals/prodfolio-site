...
export const episodes: Episode[] = [
  ...
  },
  {
    ...
    longDescription: "We brought Heidi Ram back — and she came with receipts.\n\nHeidi is a Practice Lead at The Product Recruiter and has spent 25 years placing product leaders across North America. She's seen every version of this market: the boom years, the layoffs, the slow rebuilds. And right now, she's watching a lot of talented product people make the same avoidable mistakes.\n\nThis episode picks up where Part 1 left off — and it gets specific fast. Heidi introduces a concept she calls 'candidate mode,' and breaks down what it actually looks like when product people fail to enter it. She talks about the PM who's technically sharp but can't talk to a customer, the candidate who's been interviewing for months without ever doing real discovery on the roles they're pursuing, and the senior leader still hunting for a team to scale in a market that's gone flat.\n\nThen she goes deep on resumes. Heidi profiles three resume personas she sees constantly: Jargon Jerry (all buzzwords, no value narrative), JD Julie (reads like a job description, not a career story), and Template Tom (pretty columns, zero scanability). She walks through exactly what each one needs to fix — and why the how belongs in the interview, not the doc.\n\nIf you're job searching, sitting on a dusty resume, or just starting to feel the market shift beneath you, this one's going to hit.",
